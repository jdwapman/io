...
def main(argv):
    ...
    # get all method names of the case statement - used later for automating
    # the case statement creation process, as well as the input argument
    # choices
    output_types = getClassMethods(OutputTypeCase)

    # case statement for the output type. automatically generate cases based
    # on functions of the OutputTypeClass
    case_outputtype = {}
    ...
    # case statement for the plot type. automatically generate cases based on
    # functions of the PlotTypeClass
    case_plottype = {}
    ...
    args = parseCmdLineArgs(
        argv, output_choices=output_types, plot_choices=plot_types)
    if not os.path.exists(args.o):  # create output directory
        os.makedirs(args.o)

    # Create required arguments and dictionaries (from input arguments
    # provided)
    ...
    #######CREATE DESIRED PLOT########
    ##################################
    # calls the appropriate function to generate the plot desired
    ...
    dataframe = plot_obj.get_dataframe()
