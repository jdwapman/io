...
def parseCmdLineArgs(argv, output_choices, plot_choices):
    ...
    parser.add_argument('plot_type', metavar='<plot type>', type=str,
                        help='select the plot type. Choices={%(choices)s}', choices=plot_choices)
    parser.add_argument('outputtype', metavar='<output type>', type=str,
                        help='select the desired output format. Choices={%(choices)s}', choices=output_choices)
